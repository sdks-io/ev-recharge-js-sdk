...
|  --- | --- | --- | --- |
| `requestId` | `string` | Required | A unique request id in GUID format. The value is written to the Shell API Platform audit log for end to end traceability of a request. |
...
| `data` | [`DataRetrieve[] \| undefined`](../../doc/models/data-retrieve.md) | Optional | - |
