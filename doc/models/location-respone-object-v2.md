...
| `evses` | [`EvseV2[] \| undefined`](../../doc/models/evse-v2.md) | Optional | - |
...
```ts
import { LocationResponeObjectV2 } from 'ev-recharge-sdk';

const locationResponeObjectV2: LocationResponeObjectV2 = {
