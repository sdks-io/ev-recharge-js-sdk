...
# HTTP401 Error Response Error

## Structure

`HTTP401ErrorResponseError`
...
| `errors` | [`ResponseError401AllOf1ErrorsItems[]`](../../doc/models/response-error-401-all-of-1-errors-items.md) | Required | Details of error(s) encountered |
