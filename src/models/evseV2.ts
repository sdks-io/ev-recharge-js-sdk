...
import { ConnectorV2, connectorV2Schema } from './connectorV2.js';
import {
  EvseVOStatusEnum,
...
export const evseV2Schema: Schema<EvseV2> = lazy(() =>
  object({
    ...
    connectors: ['connectors', optional(array(connectorV2Schema))],
