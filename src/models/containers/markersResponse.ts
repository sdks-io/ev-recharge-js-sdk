...
export type MarkersResponse = SingleLocationMarker | MultiLocationMarker;
...
export const markersResponseSchema: Schema<MarkersResponse> = oneOf(
  [singleLocationMarkerSchema, multiLocationMarkerSchema],
  discriminatorMap,
  'markerType'
);

export namespace MarkersResponse {
  /**
  * Validation method to narrow down union type to SingleLocationMarker type case.
  *
  * This is SingleLocationMarker case.
  */
  export function isSingleLocationMarker(value: unknown): value is SingleLocationMarker {
  ...
  */
  export function isMultiLocationMarker(value: unknown): value is MultiLocationMarker {
