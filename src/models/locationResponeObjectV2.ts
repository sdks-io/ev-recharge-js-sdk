...
import { EvseV2, evseV2Schema } from './evseV2.js';
import {
  OpeningHoursObject,
  openingHoursObjectSchema,
} from './openingHoursObject.js';

export interface LocationResponeObjectV2 {
...
export const locationResponeObjectV2Schema: Schema<LocationResponeObjectV2> = lazy(
  () =>
    object({
      ...
      evses: ['evses', optional(array(evseV2Schema))],
