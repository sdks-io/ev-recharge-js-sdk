...
} from '../models/activeResponse200Json.js';
import {
  ChargesessionStartBody,
  chargesessionStartBodySchema,
} from '../models/chargesessionStartBody.js';
import {
  GetChargeSessionRetrieveResponse200Json,
  getChargeSessionRetrieveResponse200JsonSchema,
} from '../models/getChargeSessionRetrieveResponse200Json.js';
import {
  InlineResponse202,
  inlineResponse202Schema,
} from '../models/inlineResponse202.js';
import {
  InlineResponse2021,
  inlineResponse2021Schema,
} from '../models/inlineResponse2021.js';
...
import { V2ChargeSessionRetrieve404Error } from '../errors/v2ChargeSessionRetrieve404Error.js';
import { V2ChargeSessionStart404Error } from '../errors/v2ChargeSessionStart404Error.js';
import { V2ChargeSessionStop404Error } from '../errors/v2ChargeSessionStop404Error.js';
...
export class ChargingController extends BaseController {
  ...
  async start(
    ...
    const req = this.createRequest('POST', '/v2/charge-session/start');
    ...
    req.throwOn(404, V2ChargeSessionStart404Error, 'Location Not Found');
    req.throwOn(
      429,
  ...
  async stop(
    ...
    const req = this.createRequest('POST', '/v2/charge-session/stop');
    const mapped = req.prepareArgs({
      requestId: [requestId, string()],
    ...
    req.throwOn(404, V2ChargeSessionStop404Error, 'Location Not Found');
    req.throwOn(
      429,
      TooManyRequestsError,
      'The Request reached maximum allocated rate limit'
  ...
  async getChargeSessionRetrieve(
    ...
    const req = this.createRequest('GET', '/v2/charge-session/retrieve');
    const mapped = req.prepareArgs({
      requestId: [requestId, string()],
      sessionId: [sessionId, string()],
    });
    ...
    req.throwOn(404, V2ChargeSessionRetrieve404Error, 'Location Not Found');
    req.throwOn(
      429,
      TooManyRequestsError,
      'The Request reached maximum allocated rate limit'
  ...
  async active(
    ...
    const req = this.createRequest('GET', '/v2/charge-session/active');
    const mapped = req.prepareArgs({
      requestId: [requestId, string()],
      emaId: [emaId, string()],
    });
